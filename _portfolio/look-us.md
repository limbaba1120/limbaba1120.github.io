...
배포할 때마다 **GCP 인스턴스에 미사용 Docker 이미지가 누적**되어 디스크 사용률이 90% 이상으로 증가했습니다. 디스크 공간 부족으로 서버가 불안정해지는 문제가 발생했습니다.
...
이후 디스크 공간 부족으로 인한 서버 불안정 문제가 해소되었습니다.
